...
Global Const $dll_name = StringRegExpReplace( @ScriptName, "[.].*$", "");
Global Const $skip_runtime_checks = true
#cs
Changelog:
1.0
- initial release
...
; ==== Disclaimer ====
If Not FileExists($dllpath) And Not $skip_runtime_checks Then
...
If Not FileExists($dllpath) Then
	Local Const $msgbutton = MsgBox(BitOR($MB_ICONWARNING, $MB_OKCANCEL), $dll_name, "Error: Cannot find "& $dllpath & "."&@CRLF&"Please help me find "& $dll_name& ".dll")
